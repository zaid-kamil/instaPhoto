...
import com.myapps.upesse.upes_spefest.camera.AlbumStorageDirFactory;
import com.myapps.upesse.upes_spefest.camera.BaseAlbumDirFactory;
import com.myapps.upesse.upes_spefest.camera.FroyoAlbumDirFactory;
        ...
        mSubmitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if (!(isOnline() && isConnected())) {
                    Snackbar.make(findViewById(R.id.switcher), "Could not upload image. No internet access.", Snackbar.LENGTH_LONG)
